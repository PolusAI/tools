...
class WIPPPluginManifest(WippPluginManifest):
    ...
    inputs: list[Input] = Field(  # type: ignore
        ...,
    ...
    ui: list[Union[UI1, UI2]] = Field(..., title="Plugin form UI definition")  # type: ignore
    version: Version
    ...
    # there is a bug in pydantic and
    # even though repository and website
    # are Optional[AnyUrl], they are
    # serialized as str("") if not provided
    # and this causes validation errors
    @model_validator(mode="after")
    def validate_empty(self) -> Self:
        """Validate repository and website field."""
