class: Workflow
cwlVersion: v1.2
id: file:///Users/antoinegerardin/Documents/projects/polus-tools/multi_inputs.cwl
inputs:
- id: multi_inputs___0__echo1___message
  type: string
- id: multi_inputs___1__echo2___message
  type: string
outputs:
- id: multi_inputs___0__echo1___message_string
  outputSource: 0__echo1/message_string
  type: string
- id: multi_inputs___1__echo2___message_string
  outputSource: 1__echo2/message_string
  type: string
- id: multi_inputs___2__step__uppercase2_wic_compatible3___uppercase_message
...
- id: 0__echo1
  in:
  - id: message
    source: multi_inputs___0__echo1___message
  out:
  - message_string
...
- id: 1__echo2
  in:
  - id: message
    source: multi_inputs___1__echo2___message
  out:
  - message_string
  run: file:///Users/antoinegerardin/Documents/projects/polus-tools/tests/workflows/test_data/echo_string.cwl
